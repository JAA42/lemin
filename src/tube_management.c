...
/*   Updated: 2018/06/23 21:26:44 by adhondt          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/lem_in.h"

static int		add_branch_1(t_rooms *r1, t_rooms *r2, char *str, int i, int ref)
{
	t_rooms *new_tube;
...
static void	add_branch_2(t_rooms *r2, t_rooms *r1, char *str, int i, int ref)
{
	t_rooms *new_tube;
...
static int		add_to_tubelist(t_pm *w, char *str, int i)
{
	...
	if (n != 2)
		return (0);
	if (add_branch_1(ptr, tmp, str, i, ref))
		add_branch_2(tmp, ptr, str, i, ref);
	return (1);
}
